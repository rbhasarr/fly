...
function my_loginlogo() {
  echo '<style type="text/css">
    h1 a {
      background-image: url(' . get_template_directory_uri() . '/images/logo-login.png) !important; background-size:180px auto !important; -webkit-background-size:180px auto !important; width:180px !important;
    }
  </style>';
}
...
// CHANGED URL RETURN TO SHOP WHEN CART IS EMPTY
...
add_image_size( 'home', 1920, 977);
add_image_size( 'product', 675, 422);
add_image_size( 'header_inner', 1920, 400);

//AFTER LOFIN REDIRECT TO HOME PAGE
